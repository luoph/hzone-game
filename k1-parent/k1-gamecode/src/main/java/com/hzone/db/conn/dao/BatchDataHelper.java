...
import com.hzone.util.PathUtil;
...
public class BatchDataHelper {
    ...
    public static void init() {
        ...
        for (String className : batchDataNames) {
            try {
                ...
                if(className.startsWith("com.hzone.proto")){
                    continue;
                }
    ...
    public static String findBatchDataParameterSql(AsynchronousBatchDB dataDB) {
        return findBatchDataParameterSql(dataDB.getClass().getName());
    }

    public static String findBatchDataParameterSql(String dataDB) {
        if (parameterSqlMap == null) {
            return null;
        }
        return parameterSqlMap.get(dataDB);
    }

    public static String findBatchDataAfterSql(AsynchronousBatchDB dataDB) {
       return findBatchDataAfterSql(dataDB.getClass().getName());
    }

    public static String findBatchDataAfterSql(String dataDB) {
        if (afterSqlMap == null) {
            return null;
        }
        return afterSqlMap.get(dataDB);
    }

    public static Map<String, String> getPreSqlMap() {
        return preSqlMap;
    }

    public static Map<String, String> getParameterSqlMap() {
        return parameterSqlMap;
    }

    public static Map<String, String> getAfterSqlMap() {
        return afterSqlMap;
    }
