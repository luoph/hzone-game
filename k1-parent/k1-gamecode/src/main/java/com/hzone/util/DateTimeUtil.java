...
public class DateTimeUtil {
	...
	/**
	 * 根据传入的一个时间获取这个时间当天的结束时间点毫秒数(23:59:59.999)。
	 * @param mills
	 * @return
	 */
	public static DateTime getEndDateTime(long mills){
    	if (mills == 0){
	...
	/**
	 * 根据传入的一个时间获取这个时间当天的起始时间点毫秒数(0:0:0.0)。
	 * @param mills
	 * @return
	 */
	public static DateTime getStartDateTime(long mills){
		if (mills == 0){
			throw new NullPointerException();
		}
