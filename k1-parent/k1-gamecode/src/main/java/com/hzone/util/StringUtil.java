...
public class StringUtil {
    ...
    public static <E> Stream<E> toList(String str, String spliter,
                                       Function<String, E> converter) {
        String[] arr = isEmpty(str) ? EMPTY : str.split(spliter);
    ...
    public static Long[] toLongArr(String str, String sp) {
        if ("".equals(str) || str == null) {
            return new Long[0];
        }
        //填充数值参数
