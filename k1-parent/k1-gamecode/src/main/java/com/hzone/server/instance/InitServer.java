...
import com.hzone.db.conn.ao.AOSynManager;
...
import com.hzone.tool.quartz.QuartzServer;
        ...
        try {
            ...
            for (String cmd : cmdName) {
                try {
                    ...
                    //			log.error("----------------->"+cmd);
                    while (father != null) {
                        if (father.getSimpleName().equals(superClassName) && !Modifier.isAbstract(cla.getModifiers())) {
