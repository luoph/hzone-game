package com.hzone.client;

import com.hzone.client.robot.BaseRobot;
import com.hzone.server.instance.InstanceFactory;
import com.hzone.util.PathUtil;
import com.hzone.util.RandomUtil;
...
public class ActionConsole {
	...
	public static void initAction()throws Exception{
		...
		initInstance("com.hzone.action","BaseAction",path,ActionConsole.class.getClassLoader());
